...
export const addManga = (manga) => (dispatch) => {
  ...
  mangasServices.addManga(manga).then(
    (manga) => {
...
export const deleteManga = (id) => (dispatch) => {
  ...
  mangasService.deleteManga(id).then(
    (manga) => {
...
export const editManga = (manga) => (dispatch) => {
  ...
  mangasService.editManga(manga).then(
    (manga) => {
...
export const getManga = (id) => (dispatch) => {
  ...
  mangasService.getManga(id).then(
    (manga) => {
...
export const getMangas = () => (dispatch) => {
  ...
  mangasService.getMangas().then(
    (mangas) => {
      dispatch({ type: GET_MANGAS_SUCCESS, payload: mangas })
    },
    (error) => {
      dispatch({
        type: GET_MANGAS_FAILURE,
        error: true,
