...
export const getAnimes = () => (dispatch) => {
    ...
    animesService.getAnimes().then((animes) => {
...
export const getAnime = (id) => (dispatch) => {
    ...
    animesService.getAnimme(id).then((anime) => {
...
export const addAnime = (anime) => (dispatch) => {
    ...
    animesService.addAnime(anime).then((anime) => {
...
export const editAnime = (anime) => (dispatch) => {
    ...
    animesService.editAnime(anime).then((anime) => {
...
export const deleteAnime = (id) => (dispatch) => {
    ...
    animesService.deleteAnime(id).then((anime) => {
