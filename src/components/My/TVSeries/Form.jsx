  ...
  return (
    <>
      <form  onSubmit={handleSubmit(onSubmit)}>
        ...
        <label>
          Cathegory
          <select name="cathegory" ref={register({ required: false})}>
          </select>
        </label>
        <select name="subcathegory" ref={register({ required: false})} />
        <select name="status" ref={register({required: false})} />
        <input name="date" placeholder="Date of being watched" ref={register} type="date"/>
        <input name="opinion" placeholder="opinion" ref={register({required: false})} type="text" /> 
