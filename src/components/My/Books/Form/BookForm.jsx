      ...
      {!isDecorationVisible && (
        <fieldset disabled={process.env.NODE_ENV === 'production'}>
          <Form className="books-form" onSubmit={handleSubmit}>
            <h1 className="books-form__title" style={{ marginBottom: '28px' }}>
                ...
                <span>
                  <Field
                    className={classNames(
                      'books-form-field-data__input-rating',
                      {
                        active: rating === '1',
                      }
                    )}
            ...
            <div className="books-form__sub-nav">
              <button
                ...
                disabled={process.env.NODE_ENV === 'production' || submitting}
                type="submit"
              >
                {process.env.NODE_ENV === 'production'
                  ? 'Go to books list'
                  : isEdit
                  ? 'Close, save, change the book list'
                  : 'Add Book'}
              </button>
              {process.env.NODE_ENV !== 'production' && (
                <button
